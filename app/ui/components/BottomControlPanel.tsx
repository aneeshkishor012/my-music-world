...
export default function BottomControlPanel({
    ...
    return (
        <div className="fixed bottom-1 left-0 right-0 z-[60] h-[60%] md:hidden  border-t bg-[rgb(12,20,55)] lg:bg-transparent border-gray-700 rounded-t-2xl shadow-2xl animate-slideUp">
            {/* Handle Bar */}
