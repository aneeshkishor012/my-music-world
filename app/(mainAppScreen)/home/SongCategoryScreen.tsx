    ...
    return (
        <div className="text-white h-full min-h-0 flex flex-col overflow-hidden space-y-4">
            ...
            <Input
                ...
                className="!bg-white/5 hover:!bg-white/10 focus:!bg-white/10 backdrop-blur-md rounded-xl px-4 py-2 sm:py-3 text-white border border-white/10 focus:border-purple-500/50 transition-all duration-300 placeholder:text-gray-500 shadow-[0_0_20px_rgba(0,0,0,0.3)]"
                value={localQuery}
            ...
            {debouncedQuery ? (
                <div className=" rounded-xl p-3 flex flex-col flex-1 min-h-0">
                    <div
                ...
                <div className="flex-1 flex flex-col min-h-0">
                    {/* Mobile & Desktop: Categories List as Suggestions */}
                    <div className="flex-1 overflow-y-auto px-0 pb-20 scrollbar-thin scrollbar-thumb-[#343F63] scrollbar-track-transparent">
