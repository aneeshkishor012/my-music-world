                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex flex-col min-w-0">
                                <span className={`font-semibold truncate ${isCurrent ? 'text-blue-400' : 'text-white'}`}>{song.name || song.title}</span>
                                <span className="text-sm text-gray-400 truncate">{song.artists?.primary?.[0]?.name || song.label}</span>
                            </div>
